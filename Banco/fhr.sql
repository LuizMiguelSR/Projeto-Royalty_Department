...
--
-- Host: localhost
-- Generation Time: Nov 03, 2022 at 07:28 AM
...
(1, 1212.0000, 0.0750, 2427.3500, 0.0900, 3641.0300, 0.1200, 7087.2200, 0.1400, 1903.9800, 0.0000, 2826.6500, 0.0750, 3751.0500, 0.1500, 4664.6800, 0.2250, 4664.6900, 0.2750);
...
(6, 'Comercial', 'Diretor', 5800.00),
(7, 'Operacional', 'Diretor', 7000.00),
(8, 'Operacional', 'Gerente', 8000.00),
(13, 'Marketing', 'Supervisor', 5000.00),
...
(13, 'Praça da Sé', 456, '01001901', 'Apartamento', 'São Paulo', 'Sé', 'SP', 'Brasil'),
(14, 'Praça da Sé', 456, '01001901', 'Apartamento', 'São Paulo', 'Sé', 'SP', 'Brasil'),
(21, 'Praça da Sé', 456, '01001901', 'Apartamento', 'São Paulo', 'Sé', 'SP', 'Brasil');
...
(1, 1, 1, 1, 'Administrador', '1234567890', '13245689', 12345789, 0, 'App/View/Images/UserPictures/63508c0f96f59.png'),
(2, 2, 2, 2, 'Monteiro Lobato', '1234567890', '13245689', 12345789, 2, 'App/View/Images/UserPictures/63508dd060c0b.jpg'),
(5, 5, 5, 5, 'Luiz', '1234567890', '13245689', 12345789, 0, 'App/View/Images/UserPictures/63508e9e67c9c.png'),
(6, 6, 6, 6, 'Steve Seagal', '1234567890', '13245689', 12345789, 2, 'App/View/Images/UserPictures/635dc1177f8a9.png'),
...
(13, 13, 13, 13, 'Maria Silva', '78946123', '13245689', 12345789, 2, 'App/View/Images/UserPictures/635dec3f00eee.png'),
...
(7, 6, '2022-10-29', '21:25:25', '21:25:27', '21:25:29', '21:25:31', '00:00:04'),
(8, 5, '2022-10-29', '21:37:59', '21:38:01', '21:38:03', '21:38:04', '00:00:03'),
...
(5, 5, 5, '2022-10-29', 90.90, 109.38, 145.64, 482.47, 828.39, 0.00, 69.20, 138.66, 205.56, 688.58, 1102.00, 8000.00, 5849.61),
(6, 6, 6, '2022-10-29', 90.90, 109.38, 145.64, 302.25, 648.18, 0.00, 69.20, 138.66, 205.56, 28.87, 442.29, 5800.00, 4489.54),
...
(13, 13, 13, '2022-10-30', 90.90, 109.38, 145.64, 190.25, 536.18, 0.00, 69.20, 138.66, 75.06, 0.00, 282.92, 5000.00, 3960.91),
...
(22, 6, 6, '2022-11-03', 90.90, 109.38, 145.64, 302.25, 648.18, 0.00, 69.20, 138.66, 205.57, 29.69, 443.12, 5800.00, 4488.71);
...
(1, 'admin@email.com', 1, '$2y$10$8UPIk5bVBklCTegwMHMQwe4l3FCSiG3uQP08w5oP36wnUI8w7SYm6', NULL),
(2, 'lobato@email.com', 3, '$2y$10$LdgEZdLw33ANKA4bzf1k/u.s2pSfmCqhOEgn0w704/HUSAsUlLc3e', NULL),
(5, 'luizmiguel.srodrigues@gmail.com', 2, '$2y$10$DuMUa.Tcs182h8VK6Im69uK9fz7IsIuduggqScpFe4gOrgKL76AYm', ''),
(6, 'steve@email.com', 3, '$2y$10$ukt.cmJKLwukTukWyhMhBedv.ikb0qPI2TS2xac6SSlW4lY4AXLGa', NULL),
...
(13, 'maria@email.com', 3, '$2y$10$Et5gNN0IyqYa5VBIFQEWou1yW5fWldHR1x635WmiC29sBkiPO/xMq', NULL),
...
--
ALTER TABLE `departamento`
  MODIFY `id_departamento` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `endereco`
--
ALTER TABLE `endereco`
  MODIFY `id_endereco` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `funcionario`
  MODIFY `id_funcionario` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `funcionario_ponto`
--
ALTER TABLE `funcionario_ponto`
  MODIFY `id_funcionario_ponto` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `holerite`
--
ALTER TABLE `holerite`
  MODIFY `id_holerite` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
