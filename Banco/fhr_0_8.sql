...
--
-- Host: localhost
-- Generation Time: Nov 05, 2022 at 07:28 AM
...
(1, 1213.5000, 0.0750, 2427.3500, 0.0900, 3641.0300, 0.1200, 7087.2200, 0.1400, 1903.9800, 0.0000, 2826.6500, 0.0750, 3751.0500, 0.1500, 4664.6800, 0.2250, 4664.6900, 0.2750);
...
(5, 'Praça da Sé', 1214, 1001901, 'casa', 'São Paulo', 'Sé', 'SP', 'Brasil'),
(6, 'Praça da Sé', 456, 1001901, 'casa', 'São Paulo', 'Sé', 'SP', 'Brasil'),
(7, 'Praça da Sé', 1214, 1001901, 'casa', 'São Paulo', 'Sé', 'SP', 'Brasil'),
(8, 'Praça da Sé', 1214, 1001901, 'casa', 'São Paulo', 'Sé', 'SP', 'Brasil'),
(13, 'Praça da Sé', 456, 1001901, 'Apartamento', 'São Paulo', 'Sé', 'SP', 'Brasil'),
...
(5, 'luizmiguel.srodrigues@gmail.com', 2, '$2y$10$v.QvkVHw66hW4sQ7o.KowuEVhrCYHzEH11sOyyG0mDmwIpgfqhLp.', ''),
...
--
ALTER TABLE `departamento`
  MODIFY `id_departamento` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `endereco`
--
ALTER TABLE `endereco`
  MODIFY `id_endereco` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `funcionario`
  MODIFY `id_funcionario` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `holerite`
  MODIFY `id_holerite` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
