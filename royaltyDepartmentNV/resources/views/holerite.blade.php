@php
    $title = "Holerite de ".Auth::user()->funcionario->nome_funcionario;
@endphp
...
<section>
    <main>
        ...
        <form class="row tabela"method="GET" action="{{ route('holerite.consulta') }}">
            ...
            <select id="mes" name="mes" class="form-select col" aria-label="Default select example">
            ...
            <select id="ano" name="ano" class="form-select col" aria-label="Default select example">
