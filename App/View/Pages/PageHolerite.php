    ...
    <div class="row mx-5 mt-2">
        ...
        <thead>
                <tr>
                    ...
                    ?>
                    <td class="table-dark">R$ <?= number_format($func["faixa_irrf5"], 2, ',', '.') ?></td>
                    <?php } endforeach; ?>
                </tr>
                <tr>
                    ...
                    <?php foreach((new DAOOperacoes)->select('irrf') as $func):
                        if ($_SESSION['id_funcionario'] == $func['id_irrf'] ){
                    ?>
                    <td class="table-dark">R$ <?= number_format($func["faixa_irrf4"], 2, ',', '.') ?></td>
                    <?php } endforeach; ?>
                </tr>
                <tr>
                    ...
                    <?php foreach((new DAOOperacoes)->select('irrf') as $func):
                        if ($_SESSION['id_funcionario'] == $func['id_irrf'] ){
                    ?>
                    <td class="table-dark">R$ <?= number_format($func["faixa_irrf3"], 2, ',', '.') ?></td>
                    <?php } endforeach; ?>
                </tr>
                <tr>
                    ...
                    <?php foreach((new DAOOperacoes)->select('irrf') as $func):
                        if ($_SESSION['id_funcionario'] == $func['id_irrf'] ){
                    ?>
                    <td class="table-dark">R$ <?= number_format($func["faixa_irrf2"], 2, ',', '.') ?></td>
                    <?php } endforeach; ?>
                </tr>
                <tr>
                    ...
                    <?php foreach((new DAOOperacoes)->select('irrf') as $func):
                        if ($_SESSION['id_funcionario'] == $func['id_irrf'] ){
                    ?>
                    <td class="table-dark">R$ <?= number_format($func["faixa_irrf1"], 2, ',', '.') ?></td>
                    <?php } endforeach; ?>
                </tr>
                <tr>
        ...
        <table class="table table-bordered border-success hole">
            ...
            <tbody>
                <tr>
                    ...
                    ?>
                            <td class="table-dark">R$ <?= number_format($func["salario_liquido"], 2, ',', '.') ?></td>
                    <?php } endforeach; ?>
                </tr>
            </tbody>
        </table>
