...
<body>
    ...
    <section>
        ...
        <main>
            ...
            <div class="row mt-1">
                <form class="row g-3 formCad" method="post" enctype="multipart/form-data" action="/cadastrarFuncionarioValida">
                    <!-- Dados Pessoais -->
                    ...
                    <div class="col-12">
                        <input name="arquivo" type="file" class="form-control-file" id="arquivo">
                    </div>
